...
const reviews = [
  {
    quote: "Здесь появится настоящий отзыв клиента о работе с EZBusiness.",
    name: "Ваш клиент",
    ...
    <main className="min-h-screen overflow-hidden bg-[#0B1220] text-white">
      ...
      <section className="relative">
        ...
        <div className="relative mx-auto max-w-5xl px-5 py-24 text-center sm:px-8 lg:py-32">
          ...
          <div className="inline-flex rounded-full border border-orange-500/30 bg-orange-500/[0.06] px-5 py-2.5 text-sm font-semibold text-orange-400">
            ОТЗЫВЫ
          </div>

          <h1 className="mt-8 text-5xl font-extrabold tracking-[-0.04em] sm:text-6xl lg:text-7xl">
            Истории людей,
      ...
      <section className="border-y border-white/10 bg-[#0D1524]">
        ...
        <div className="mx-auto max-w-7xl px-5 py-24 sm:px-8 lg:py-32">
          ...
          <div className="grid gap-5 lg:grid-cols-3">
            ...
            {reviews.map((review, index) => (
              <article
                ...
                className={`rounded-[30px] border border-white/10 bg-[#111A2B] p-8 transition duration-300 hover:-translate-y-2 hover:border-orange-500/30 ${
                  index === 1
                    ? "lg:-translate-y-6 lg:border-orange-500/20 lg:bg-orange-500/[0.035]"
                    : ""
                }`}
              >

                <div className="text-6xl leading-none text-orange-500">
                  “
                </div>
          ...
          <div className="mt-10 rounded-3xl border border-dashed border-white/10 bg-white/[0.02] p-7 text-center text-sm text-gray-500">
            Здесь будут опубликованы реальные отзывы клиентов EZBusiness.
          </div>
      ...
      <section className="relative">
        ...
        <div className="pointer-events-none absolute left-1/2 bottom-0 h-72 w-96 -translate-x-1/2 rounded-full bg-orange-600/10 blur-[120px]" />
