    ...
    <main className="min-h-screen overflow-hidden bg-[#0B1220]">
      ...
      <section className="relative">
        ...
        <div className="relative mx-auto max-w-7xl px-5 pb-16 pt-16 sm:px-8 sm:pb-20 sm:pt-24">
          {/* LABEL */}
          <div className="mb-8 inline-flex items-center rounded-full border border-orange-500/50 bg-[#15120F] px-6 py-3 text-sm font-semibold tracking-[0.08em] text-orange-400 shadow-[0_0_30px_rgba(249,115,22,0.08)]">
            КОНТАКТЫ
          </div>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          ...
          >
            ...
            <div className="relative flex h-full flex-col justify-between">
              ...
              <div className="flex items-center justify-between">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-orange-500/10 text-xl text-orange-400 transition duration-300 group-hover:bg-orange-500/15">
                  ↗
                </div>
              ...
              <div className="mt-16">
                ...
                <p className="mt-3 max-w-sm text-sm leading-6 text-gray-500">
                  Самый быстрый способ связаться со мной и обсудить вашу идею.
                </p>
              </div>
            </div>
          </a>
          ...
          >
            ...
            <div className="relative flex h-full flex-col justify-between">
              {/* Top */}
              <div className="flex items-center justify-between">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white/5 text-xl text-gray-300 transition duration-300 group-hover:bg-orange-500/10 group-hover:text-orange-400">
                  @
                </div>
      ...
      <section className="mx-auto max-w-7xl px-5 pb-20 sm:px-8">
        <div className="relative overflow-hidden rounded-[32px] border border-white/10 bg-gradient-to-br from-[#172033] via-[#111A2B] to-[#0F1726] p-7 sm:p-10 lg:p-12">
          ...
          <div className="relative grid gap-10 lg:grid-cols-[1fr_auto] lg:items-center">
            ...
            <Link
              href="/ai"
              className="group inline-flex w-fit items-center gap-3 rounded-2xl bg-orange-600 px-6 py-4 text-sm font-semibold text-white shadow-lg shadow-orange-950/20 transition duration-300 hover:bg-orange-500 hover:shadow-orange-900/30"
            >
